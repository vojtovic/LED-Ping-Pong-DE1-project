...
REM
REM Generated by Vivado on Sun Apr 19 21:13:14 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_control_logic_vhdl.prj"
call xvhdl  --incr --relax -prj tb_control_logic_vhdl.prj -log xvhdl.log
