...
REM
REM Generated by Vivado on Wed Apr 08 13:10:45 +0200 2026
...
echo "xvhdl --incr --relax -prj cfg_tb_reverse_counter_vhdl.prj"
call xvhdl  --incr --relax -prj cfg_tb_reverse_counter_vhdl.prj -log xvhdl.log
